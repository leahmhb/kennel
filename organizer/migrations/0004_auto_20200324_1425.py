...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('organizer', '0003_kennel_country'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='kennel',
            options={'ordering': ['name'], 'verbose_name_plural': 'Kennels'},
        ),
        migrations.AlterModelOptions(
            name='person',
